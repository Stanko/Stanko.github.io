      ...
      <div className="post-card__content">
        ...
        <ArrowTitle size="lg">
          <span
            ...
            dangerouslySetInnerHTML={{ __html: post.pageData.title }}
          />
        </ArrowTitle>
        {post.pageData.intro && (
