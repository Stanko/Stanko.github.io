...
<Image src='./img/chrome.png' alt="Display flex on buttons, Chrome" />

#### Firefox

<Image src='./img/firefox.png' alt="Display flex on buttons, Firefox" />

#### Safari 8

<Image src='./img/safari8.png' alt="Display flex on buttons, Safari 8" />

#### Safari 9

<Image src='./img/safari9.png' alt="Display flex on buttons, Safari 9" />

#### IE10

<Image src='./img/ie10.png' alt="Display flex on buttons, IE10" />

#### IE11

<Image src='./img/ie11.png' alt="Display flex on buttons, IE11" />

#### CodePen

<Codepen id="ALjvYj" title="Fix for button display: flex" height={300} />
