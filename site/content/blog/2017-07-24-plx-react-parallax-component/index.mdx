...
comments = [
  "comments/plx-react-parallax-component/1527834332799.json",
  "comments/plx-react-parallax-component/1537823659329.json",
  "comments/plx-react-parallax-component/1537946171517.json",
  "comments/plx-react-parallax-component/1551715627690.json",
  "comments/plx-react-parallax-component/1551717648217.json",
  "comments/plx-react-parallax-component/1562647094893.json",
  "comments/plx-react-parallax-component/1562659199979.json",
  "comments/plx-react-parallax-component/1572898221633.json"
]
image = "./plx-explode.png"
favorite = true
...
<Sidenote note={`the effect whereby the position or direction of an object appears to differ when
viewed from different positions, e.g. through the viewfinder and the lens of a camera.`}>wrong term</Sidenote>
...
<Sidenote note={`The most performant properties to animate are \`opacity\` and \`transform\`. So stick to those two to keep your parallax effects performant. Of course you can animate something else here and there, but be careful and test it throughly.`}>`opacity`, `height`, `padding`</Sidenote>
