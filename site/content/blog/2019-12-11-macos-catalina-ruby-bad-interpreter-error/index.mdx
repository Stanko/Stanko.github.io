...
comments = [
  "comments/macos-catalina-ruby-bad-interpreter-error/1581333359330.json",
  "comments/macos-catalina-ruby-bad-interpreter-error/1581333993703.json",
  "comments/macos-catalina-ruby-bad-interpreter-error/1590675200152.json",
  "comments/macos-catalina-ruby-bad-interpreter-error/1594769534724.json",
  "comments/macos-catalina-ruby-bad-interpreter-error/1594795431477.json",
  "comments/macos-catalina-ruby-bad-interpreter-error/1596190492431.json",
  "comments/macos-catalina-ruby-bad-interpreter-error/1597902815567.json",
  "comments/macos-catalina-ruby-bad-interpreter-error/1597949056674.json",
  "comments/macos-catalina-ruby-bad-interpreter-error/1599820087118.json",
  "comments/macos-catalina-ruby-bad-interpreter-error/1599822113207.json",
  "comments/macos-catalina-ruby-bad-interpreter-error/1604872693798.json"
]
image = "./catalina-ruby-bad-interpreter.png"

+++


Another Catalina rant, this time about Ruby. As far as I know, on MacOS, it is advisable to
<Sidenote note={`For example users don't have write permission on the system's gems folder.`}>leave system Ruby version to the OS</Sidenote>
...
<Image
  src="./catalina-ruby-bad-interpreter.png"
