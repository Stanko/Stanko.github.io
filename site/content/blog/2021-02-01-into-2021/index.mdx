...
<Image
  src="./img/black-holes.jpg"
  alt={"Me holding my generative piece \"Black Holes\""} size="side"
/>

<Image
  src="./img/truchet.jpg"
  alt={"\"Untitled\", drawing based on Truchet tiling"} size="side"
/>
...
<Image
  src="./img/beach.jpg"
  alt={"\"Beach\", generative piece consisting of 116 thousands dots"} size="side" outline
/>
...
I'm fortunate enough to have a dedicate work space. A small study with a <Sidenote note={`I'm a big fan of Steelcase chairs`}>good chair</Sidenote> and a monitor. Pretty much the same setup as the one I have at work. All in all, I think I was more productive working from home, mainly due to the lack of distractions. But man, I miss working from office, along with all of it's distractions.
...
<Image
  src="./img/workco.jpg"
  alt={"Work & Co website"} link={"https://work.co"} size="side" outline
/>
...
<Image
  src="./img/npm.png"
  alt="Stats for my npm packages, for 2020"
  link="https://npm-stat.com/charts.html?author=stanko&from=2020-01-01&to=2020-12-31"
/>
...
Post is a little bit chaotic, which fits the theme of 2020. I just wanted to get it out there as it took me so long to finish it. Thank you for reading my ramblings and <Sidenote note={`It has to be, right?!`}>let's hope 2021 will be a better year.</Sidenote>
