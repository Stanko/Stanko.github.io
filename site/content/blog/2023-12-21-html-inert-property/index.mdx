...
<div inert style={{
  ...
  <div style={{marginTop:10}}><button style={{display:'inline-block'}} className="btn btn--sm">You can't click me</button><a href="/" style={{marginLeft: 20}}>Nor me!</a></div>
</div>
...
<Spoiler hide={"Hide source code"} show={"Show source code"}>
