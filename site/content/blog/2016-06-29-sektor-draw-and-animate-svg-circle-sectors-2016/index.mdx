...
tags = ["js","svg"]
comments = [
  "comments/sektor-draw-and-animate-svg-circle-sectors-2016/1560402028559.json",
  "comments/sektor-draw-and-animate-svg-circle-sectors-2016/1560414071172.json",
  "comments/sektor-draw-and-animate-svg-circle-sectors-2016/1560481572425.json"
]
...
<Image
  src="./sektor.png"
  alt="Sektor - draw and animate SVG circle" 
  link="https://muffinman.io/sektor/"
/>
