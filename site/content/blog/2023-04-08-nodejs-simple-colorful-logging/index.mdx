...
<Image
  src='./img/simple.png'
  alt="Colorful output strings in terminal" 
/>
...
<button className="btn btn--empty btn--log-lemon">Log 🍋 Lemon</button>
<script 
  dangerouslySetInnerHTML={{ 
    __html: `document.querySelector(".btn--log-lemon").addEventListener("click", () => {
      console.log("%c🍋 Lemon", "background: black; color: yellow;");
    });`
  }} 
/>
