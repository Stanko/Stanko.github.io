...
tags = ["js"]
comments = [
  "comments/simple-javascript-api-wrapper/1512653087122.json",
  "comments/simple-javascript-api-wrapper/1512655145230.json",
  "comments/simple-javascript-api-wrapper/1524864152433.json",
  "comments/simple-javascript-api-wrapper/1592322434948.json"
]
...
<Sidenote note={`If you need a polyfill [isomorphic-fetch](https://www.npmjs.com/package/isomorphic-fetch) is a great one.`}>native `fetch`.</Sidenote>

* For successful requests it will parse the response and return it.
* When
  <Sidenote note={`It detects errors based on request's HTTP status.`}>HTTP error occurs</Sidenote>
...
I've cooked a small demo to show it in practice, in which I used free [Star Wars API](https://swapi.tech).

<Codepen id={"LOoPQp"} title={"Simple JavaScript API wrapper demo"} height={500} />
