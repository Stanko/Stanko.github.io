...
image = "./lines-of-text.png"

+++


<link rel="stylesheet" href="/css/posts/text-lines.css" />

I was tasked with getting lines of text from an element many times. Usually it was to
<Sidenote note={`Before [line-clamp](https://developer.mozilla.org/en-US/docs/Web/CSS/-webkit-line-clamp) was a thing`}>truncate the text</Sidenote>
...
<div className="example example--demo is-in-viewport">
  ...
  <div className="example-handle" title="Drag to resize"><span></span></div>
</div>
...
Apologies if I made any mistakes with your language - I used Google Translate with the original English text.

### English

<div className="example example--debug">
  <div className="example-text">
    Information is not knowledge.
    Knowledge is not wisdom.
    Wisdom is not truth.
...
<div className="example example--debug">
  <div className="example-text" dir="rtl">
