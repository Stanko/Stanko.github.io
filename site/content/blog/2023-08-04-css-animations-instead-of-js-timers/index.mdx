...
image = "./css-animations-as-timers.png"

+++



<link rel="stylesheet" href="/css/posts/css-timers.css" />
...
To make the timer, we'll need <Sidenote note={`Please note that we could create a minimal example with only two classes (\`.timer\` and \`.timer--running\`), but it is pretty limiting and therefore we are going to skip it.`}>four CSS classes</Sidenote>:
...
<div className="timer-demo">
  <div className="timer-wrapper timer-wrapper--linear">
    <div className="timer timer--linear"></div>
  </div>

  <button className="btn btn--sm timer-toggle">Start / stop</button>

  <p className="timer-log small"></p>
</div>
...
<div className="timer-demo red">
  <div className="timer-wrapper timer-wrapper--radial">
    <div className="timer timer--radial"></div>
  </div>
...
<div className="timer-chaining-demo">
  <div className="timer-chaining-demo-timers">
    <div className="timer-wrapper timer-wrapper--linear">
      <div className="timer timer--linear timer--short"></div>
    </div>
    <div className="timer-wrapper timer-wrapper--linear">
      <div className="timer timer--linear timer--short"></div>
    </div>
...
<Codepen id={"dyQrOeB"} title={"Autoplay carousel using CSS animations"} height={370} />
...
<div className="timer-demo purple">
  <div className="timer-wrapper timer-wrapper--linear">
    <div className="timer timer--linear timer--steps"></div>
  </div>
