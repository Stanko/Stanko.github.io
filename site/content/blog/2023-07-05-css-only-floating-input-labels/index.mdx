...
image = "./css-only-floating-label.png"
+++


<link rel="stylesheet" href="/css/posts/floating-labels.css" />
...
<div className="basic-demo">
  <input className="basic-input" placeholder="Placeholder" />
  <div className="basic-states">
    <div className="has-value">Input has value</div>
    <div className="is-empty">Input is empty</div>
...
<div className="input-wrapper">
  ...
  <button className="clear" aria-label="Clear input">
