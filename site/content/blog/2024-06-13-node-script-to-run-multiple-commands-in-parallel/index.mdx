...
<Sidenote note={`In the finished version, I added an option to disable colors, as I know some people really don't like colors in their terminals`}>color-coded</Sidenote> name.
...
<Image src="./runner.png" alt="Screenshot of the terminal window showing the script in action" />
