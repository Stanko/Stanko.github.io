...
We built it using
<Sidenote note={`React static site generator`}>Gatsby</Sidenote>
...
<Sidenote note={`While replacing keybord on my MacBook, Apple support killed the hard drive and I lost everything on it.`}>huge post draft</Sidenote> on it.
...
<Image
  src='./img/npm.png'
  alt="Stats for my npm packages in 2019"
  link="https://npm-stat.com/charts.html?author=stanko&from=2019-01-01&to=2019-12-31"
/>

### Redux Spark

One library I hoped would gain more traction is [redux-spark](https://github.com/Stanko/redux-spark).
<Sidenote note={`I wrote it together with my friend Radoš.`}>We</Sidenote>
