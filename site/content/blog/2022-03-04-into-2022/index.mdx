...
<Image alt="Space Armadillo (aka Pokeball)" src="./img/pokeball1.jpg" />

<Image alt="Untitled" src="./img/untitled.jpg" />

<Image alt="Krypton" src="./img/krypton.jpg" />
...
<Image alt="Analytics breakdown for 2021" src="./img/analytics.png" outline />


Luckily, now I have way more drive to write and keep the site updated.

This February, the blog got a redesign that I planned for a long time. I wanted to add "Art" and "Projects" sections, but I kept redesigning it over and over again. Finally, when I decided to <Sidenote note={`I'll probably cover that in a another post.`}>switch from Jekyll</Sidenote> to [Zola](https://www.getzola.org/) I was able to focus and finish the redesign.
...
This one is really close to my heart. I created a physical pixel art frame and I call it "Retro frame". This is just a teaser, I plan on doing a write up and [open sourcing everything](https://github.com/stanko/retro-frame).

<Video src="./img/mario.mp4" loop />

Just looking at <Sidenote note={`Check the original animation on the [artist's website](https://rephil.dribbble.com/)`}>this video</Sidenote> makes me happy!
...
<Image alt="Npm packages stats for 2021" src="./img/npm.png" link="https://npm-stat.com/charts.html?author=stanko&from=2021-01-01&to=2021-12-31" outline />
