...
<link rel="stylesheet" href="/css/posts/giraffe.css" />
...
<Codepen id={"vYVyZzO"} title={"Custom Giraffe Caret"} height={310} />
...
<div className="giraffe">
  <input
    ...
    defaultValue="Hello Friends!"
    type="text"
    className="giraffe-input"
  />
  <div className="giraffe-clone" aria-hidden="true">
    <div className="giraffe-content">
      <span className="giraffe-before"></span><span className="giraffe-caret"><svg xmlns="http://www.w3.org/2000/svg" width="264" height="211" fill="none" viewBox="0 0 264 211">
...
<path fill="#F5B953" d="m83.5 27-3 102h-34c-15 0-21.5 9.5-21.5 21v11l1.936 50h7.741L37 161h2l1.935 50h7.742L51 161h19l1.936 50h7.741L82 161h2l1.936 50h7.741L96 161v-32l-2.5-96.5-10-5.5Z" clipRule="evenodd"/>
<path fill="#4D5D7A" d="m26.548 201 .388 10h7.741l.465-10h-8.594ZM40.548 201l.387 10h7.742l.465-10h-8.594ZM71.548 201l.388 10h7.741l.465-10h-8.594ZM85.548 201l.388 10h7.741l.465-10h-8.594Z" clipRule="evenodd"/>
...
<path stroke="#F5B953" strokeWidth="6" d="M8 163.135c0-17 5.5-28.135 27.123-28.135"/>
...
<path fill="#F5B953" d="m212.5 143 3-102 10 5.5L228 143v29l2.5 15.5-4.823 23.5h-7.742l3.565-21.5-5-14.5v12.5l-4.823 23.5h-7.742l3.565-21.5-3.565-14.5H185.5v12.5l-4.823 23.5h-7.742l3.565-21.5-4-14.5h-1v12.5l-4.823 23.5h-7.742l3.565-21.5-4-14.5-1-4.5s-.5-2.465-.5-6.5c0-11.5 6.5-21 21.5-21h34Z" clipRule="evenodd"/>
...
<path stroke="#4D5D7A" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M223 39h6"/>
<path stroke="#F5B953" strokeWidth="6" d="M140 177.135c0-17 5.5-28.135 27.123-28.135"/>
...
<path fill="#4D5D7A" d="M168.73 201h-8.137l-1.658 10h7.742l2.053-10ZM182.73 201h-8.137l-1.658 10h7.742l2.053-10ZM213.73 201h-8.137l-1.658 10h7.742l2.053-10ZM227.73 201h-8.137l-1.658 10h7.742l2.053-10Z" clipRule="evenodd"/>
<path fill="#AF7142" d="M168.01 145c2.882-1.281 6.364-2 10.49-2h9.201c-1.122 4.592-5.264 8-10.201 8a10.503 10.503 0 0 1-9.49-6Zm-7.43 37.541L158.5 175l-1-4.5s-.5-2.465-.5-6.5c0-.671.022-1.335.067-1.991.143-.006.288-.009.433-.009 5.799 0 10.5 4.701 10.5 10.5 0 4.727-3.124 8.725-7.42 10.041ZM199.747 175H185.5v2.118a10.488 10.488 0 0 1-4.5-8.618c0-5.799 4.701-10.5 10.5-10.5s10.5 4.701 10.5 10.5c0 2.454-.842 4.712-2.253 6.5ZM228 167.062V172l1.699 10.533A8 8 0 1 1 228 167.062Zm-.744-52.795.481 18.57c-4.404-.827-7.737-4.693-7.737-9.337 0-4.474 3.092-8.225 7.256-9.233Zm-13.278-21.525.459-15.59a8 8 0 1 1-.459 15.59ZM210 160a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z" clipRule="evenodd"/>
</svg></span><span className="giraffe-after"></span>
    </div>
    <div className="giraffe-padding"></div>
  </div>
</div>

<label className="giraffe-checkbox-label">
<input type="checkbox" className="giraffe-checkbox giraffe-checkbox--overlap" /> Overlap
</label>
...
None of these events are perfect, and <Sidenote note="Wrapping the update method in `requestAnimationFrame` fixed the delay.">~there is a slight delay~</Sidenote>. Personally, I don't mind it since the whole thing was meant to be fun and goofy.
...
![Base vector image of the giraffe, wireframe and colored version](./img/base.svg)

Animation keyframes:

![Giraffe animation keyframes](./img/keyframes.svg)
