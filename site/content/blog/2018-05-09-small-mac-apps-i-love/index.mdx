...
tags = ["mac","apps","bash"]
comments = [
  "comments/small-mac-apps-i-love/1535092268404.json",
  "comments/small-mac-apps-i-love/1535092772226.json"
]
image = "./img/itsycal.png"

+++


Recently I switched to a new laptop and had to set it up
<Sidenote note={`[This comic](https://xkcd.com/1806/) describes my setup pretty accurately.`}>to my likings.</Sidenote>
...
<Image
  alt="AppCleaner window"
  src='./img/appcleaner.png'
  transparent
/>
...
<Image
  alt="CopyClip clipboard history"
  src='./img/copyclip.png'
/>
...
<Image
  alt="Itsycal with default date icon"
  src='./img/itsycal-icon.png'
/>

Custom date formats are supported as well, allowing you replace Mac's clock completely.

<Image
  alt="Itsycal using custom date format"
  src='./img/itsycal.png'
/>
...
<Image
  alt="Spectacle main window"
  src='./img/spectacle.png'
  transparent
/>
...
<Sidenote note={`I just realized Unarchiver was acquired by MacPaw,
hopefully they'll keep it free and simple.`}>most popular</Sidenote>
on this list.
...
<Image
  alt="TotalFinder dual mode"
  src='./img/totalfinder.png'
  transparent
/>
