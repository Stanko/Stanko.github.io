...
tags = ["ios"," safari"," bug"]
comments = [
  "comments/ios-safari-get-bounding-client-rect-bug/1535079038028.json"
]
...
<Sidenote note={`Same will happen for horizontal scroll and \`left\` value.`}>incorrect `top` value.</Sidenote>
...
<Sidenote note={`Unfortunately I couldn't include the iframe with the demo, because of the [other bug](https://bugs.webkit.org/show_bug.cgi?id=172854). Today's your lucky day, you got two bugs by the price of one!`}>to see it yourself.</Sidenote>
