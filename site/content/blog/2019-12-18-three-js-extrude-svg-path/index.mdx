...
Replaced `path.toShapes(true)` with `SVGLoader.createShapes(path)` because `toShapes` misses some of the SVG-specific logic implemented in the loader. Thanks to forresto who [pointed it out](https://github.com/Stanko/Stanko.github.io/issues/456). Also updated the demo to use a fresh version of ThreeJS.
