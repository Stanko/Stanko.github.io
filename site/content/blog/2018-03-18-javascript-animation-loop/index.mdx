...
<Sidenote note={`In the example bellow I faked it by using 100ms \`setTimeout\`.`}>10 times per second.</Sidenote>
...
I hope I'll write more posts about three.js and JavaScript game development in the future.
