...
All three are completely different and they vary from a vanilla JavaScript ASCII rendered game, followed by a simple ThreeJS demo to <Sidenote note={`To be fair, these are only complex in the context of using CSS to render them.`}>the complex 3D shapes CSS objects.</Sidenote>
