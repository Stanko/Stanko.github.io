...
image = "./zsh-nagging.png"

+++


Yesterday I
<Sidenote note={`To be able to [use AirPods Pro with it](https://support.apple.com/en-us/HT208718) :/`}>updated my work laptop to MacOS Catalina.</Sidenote>
