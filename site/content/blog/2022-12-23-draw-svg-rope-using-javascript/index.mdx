...
intro = "Transforming a SVG path into a rope drawing turned out to be a surprisingly fun problem to solve. Please allow me to walk you through the process, the challenges and the small tricks that made it work."
image = "./img/cover.png"
favorite = true
