...
<Sidenote note={`I always hated how even the term tries to disguise the real purpose - advertising.`}>sponsored posts</Sidenote>. I never intended to do this, so I turned all of these offers down.
...
I would write a post and feel like it wasn't good or *professional* enough and just scrape it. For that reason I never wrote about some projects that I'm super excited and proud about (for example [Vertigo](https://muffinman.io/vertigo/) or [Retro Frame](https://github.com/stanko/retro-frame)). Writing is <Sidenote note={`Especially in a foreign language`}>hard enough as it is</Sidenote>, and this newly added pressure made it even harder.
