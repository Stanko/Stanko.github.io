...
comments = [
  "comments/animate-between-two-react-components/1509374148432.json",
  "comments/animate-between-two-react-components/1509375270692.json"
]
...
<Codepen id={"eGwNZd"} title={"React transition between two components"} height={500} />
