...
<Image
  src='./img/usb-sound-card.jpg'
  alt="USB sound card that comes with Cloud II headphones"
/>
...
<Image
  src='./img/wires.jpg'
  alt="USB connector with wires soldered in the correct order"
/>
