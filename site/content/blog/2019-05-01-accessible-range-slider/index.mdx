...
<Image
  src='./range-slider.png'
  alt="Range slider screenshot"
/>
...
<Sidenote note={`Similar like it goes with tests. I do it myself, too - I get excited about the problem, start hacking, and couple of hours later I have a decent codebase and zero tests.`}>when library is complete.</Sidenote>
