...
<Sidenote note={`Always include at least basic video controls for accessibility`}>play/pause button</Sidenote>
...
<Codepen id={"WNxwreJ"} title={"React - Simple video buffering loader"} height={550} />
