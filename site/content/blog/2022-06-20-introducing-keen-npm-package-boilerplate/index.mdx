...
<Image alt="Terminal windows with keen's node_modules folder listed" src="./dependencies.png" caption="These are all of the keen dependencies." />
...
<Spoiler hide={"Hide tsconfig-esm.json"} show={"Show tsconfig-esm.json"}>
...
<Spoiler hide={"Hide tsconfig-cjs.json"} show={"Show tsconfig-cjs.json"}>
