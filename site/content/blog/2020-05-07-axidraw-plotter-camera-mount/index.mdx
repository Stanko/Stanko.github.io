...
<Sidenote note={`For now, you can see my work on my [Instagram](https://www.instagram.com/muffinman_io/) profile.
Expect new posts about my process and tools in the near future.`}>generative art</Sidenote>.
...
<Sidenote note={`Luckily I ordered two.`}>break one</Sidenote>
...
<Image
  alt="Camera on the 3d printed mount"
  src='./img/front.jpg'
/>
...
<Image
  alt="Back and side views of the mount"
  src='./img/back-and-side.jpg'
/>
...
<Video
  src='./img/stars.mp4'
  caption="White pen drawing stars on the black paper, the first video I recorded using the mount"
