...
comments = [
  "comments/disable-cmd-mouse-wheel-zoom-in-firefox/1605679092247.json"
]
image = "./ff-about-config.png"
...
<Sidenote note={`This page will allow you to change hidden browser settings, so be careful with it.`}>warning page</Sidenote>
may appear. Continue like the hacker you are, and search for `mousewheel.with_meta`. You should see something like this:

<Image
  src='./ff-about-config.png'
  alt="Firefox about:config page"
  transparent
/>
