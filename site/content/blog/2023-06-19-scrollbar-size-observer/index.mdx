...
<pre className="scrollbar-size z-code"></pre>

<button className="btn btn--sm toggle-scrollbar">Toggle scrollbar</button>
...
<link rel="stylesheet" href="/css/posts/scrollbar-size-observer.css" />
<script src="/js/posts/scrollbar-size-observer.js"></script>
