...
tags = ["html","video"]
comments = [
  "comments/hack-for-ios-safari-to-display-html-video-thumbnail/1606315838380.json",
  "comments/hack-for-ios-safari-to-display-html-video-thumbnail/1611243895371.json"
]
image = "./ios-safari-video-thumbnail-hack.jpg"
...
<Grid sm={1}>
  <figure className='video__figure'>
    <video
      ...
      playsInline
      src='./video.mp4' />
    <figcaption className='video__figcaption'>Without media fragments</figcaption>
  </figure>
  
  <Video src='./video.mp4' caption="With media fragments" />
</Grid>
