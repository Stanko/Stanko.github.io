...
<Codepen id="XWYrXvJ" title="" height={400} htmlId="demo" />
...
* Animation loop <Sidenote note={`Don't get confused, as I keep using both of these terms interchangeably.`}>(aka game loop)</Sidenote>
...
<Spoiler hide={"Hide enum"} show={"Show enum"}>
...
{/* <Image src={"/img/2d-controls/game-state.gif"} alt={""} size={"xs"} /> */}
...
<Spoiler hide={"Hide trail related code"} show={"Show trail related code"}>
