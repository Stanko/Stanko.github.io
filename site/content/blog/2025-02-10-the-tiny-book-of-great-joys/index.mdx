...
image = "./img/the-book-02.jpg"
favorite = true
+++

If you are interested in how I over-engineered the process of making a tiny book for my wife, using AI, a pen plotter, a 3D printer, and a lot of time, you are in the right place. The book is titled <Sidenote note="*Mala Knjiga Velikih Radosti* in Serbian">The Tiny Book of Great Joys</Sidenote>, and here is how it turned out:

![The Tiny Book of Great Joys sitting on the table slightly open with the title page showing](./img/the-book-01.jpg)
...
![Black and white drawing of a cute fox curled up sleeping.](./img/01-fox.jpg)
...
![A bunch of attempts at drawing Link from Zelda](./img/fails.png)
...
Most of my images were generated using that `sref` code and a <Sidenote note="A number that tells Midjourney how much the reference should influence the final output">style weight</Sidenote> between 150 and 400 (it can go from 0 to 1000).
...
![The same fox drawing, but but drawn with a lot of small dots, using technique similar to halftone](./img/02-fox.jpg)
...
Here is the image of Link from _The Legend of Zelda_ generated by Midjourney:

![Black and white cartoony drawing of Link from The Legend of Zelda standing with a sword and shield.](./img/link-01-midjourney.png)
...
![Vectorized image of Link using common vectorization technique with each area outlined black](./img/link-03-shapes.png)
...
![Vectorized image of Link using centerline tracing, looking much more like a real drawing](./img/link-04-before.png)
...
![Lines that are crossing and touching before and after centerline tracing](./img/tracing-01.png)

But I found out that if I roughly separate these lines, I get a much better result.

![Lines that are crossing and touching, but slightly separated before tracing, with the result being much better](./img/tracing-02.png)
...
![The image of Link, but this time with lines slightly separated and details removed](./img/link-02-after-cleanup.png)

And finally, when we trace this image, we get a really nice and clean vector file perfect for plotting.
![Very clean vectorized image of Link](./img/link-05-after.png)

Here is another example. We start with the image I generated using Midjourney:

![Black and white drawing of a woman, man, little girl and a dog walking in a forest](./img/setnja-01.png)

After editing, removing details and separating lines, we get this one:

![The same image of the family walking in the forest but with lines separated and some parts redrawn](./img/setnja-02.png)

And the traced vector result:

![Vectorized image of of the family walking in the forest](./img/setnja-03.png)

You'll notice that in both examples I did <Sidenote note="For example, in the second image, I redraw the dog completely to look like our dog Zappa.">some redrawing</Sidenote>. I did that for pretty much all of the images, to fix things I wasn't able to polish using prompts. I also removed a lot of details to make sure images are crisp and readable at the small size.
...
### <Sidenote note="Name of the main villain Link fights against in The Legend of Zelda series">Ganon</Sidenote> never stood a chance!

Before we continue I just want to show you two funky images of Link that really made me laugh:

![Funky looking Links generated by Midjourney](./img/funky-links.jpg)
...
![Title of the book in English and Aerbian in EMS Elfin font](./img/fonts.png)
...
![Layout of the book ready for plotting](./img/layout.jpg)
...
Here you can see the first <Sidenote note="Sorry for the poor quality photos, I threw the plots away, so these are the only ones I have">two test plots</Sidenote> using markers of 0.2mm and 0.1mm thickness respectively. Lines got a bit smudged and looked much thicker than I expected. This was also the moment I realized I need to remove <Sidenote note="A friend of mine said that in these plots, Link looks like he has measles">a lot of details</Sidenote> from the images to make them readable at this size.

![Test plot using 0.2mm marker](./img/marker-02.jpg)
![Test plot using 0.1mm marker](./img/marker-01.jpg)
...
![Test plot using a technical pen](./img/technical-pen-01.jpg)
...
![3D printed tool, closed, with needle poking through it](./img/3d-print-01.jpg)

![3D printed tool, opened, with the sheet with sewing holes visible still in it](./img/3d-print-02.jpg)

Here you can see all of the eight sheets with sewing holes.

![All eight sheets with illustrations ready for sewing](./img/pages-with-sewing-holes.jpg)

Fun fact, I designed all 3D parts using JavaScript and [Replicad](https://replicad.xyz/) library. Here is [a link](https://studio.replicad.xyz/workbench?from-url=https://muffinman.io./img/model.js) if you want to play with the model in your browser.

[![Application showing code and the 3D model](./img/model-code.png)](https://studio.replicad.xyz/workbench?from-url=https://muffinman.io./img/model.js)

But I ditched the 3D printed spine and used the technique called _pamphlet stitch_, which works great when you have only two signatures. It made signatures way more tight than when I connected them separately to the 3D printed spine.

![Two book signatures sewn together using pamphlet stich](./img/pamphlet-stich.jpg)

![Two book signatures opened at the exact point where they meet](./img/signatures.jpg)
...
![Cardboard sides laid out in the bookbinding canvas](./img/binding.jpg)
...
![Book opened on the table showing the illustration of the family walking in the forrest](./img/the-book-06.jpg)
...
![Book opened on the table showing the illustration of Link from The Legend of Zelda](./img/the-book-07.jpg)
