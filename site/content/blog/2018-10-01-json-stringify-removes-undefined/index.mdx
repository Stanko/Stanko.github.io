...
tags = ["js"," json"]
comments = [
  "comments/json-stringify-removes-undefined/1603186680422.json"
]
...
<Sidenote note={`Third one is \`space\`, number of spaces or a string to be used for indentation`}>second parameter</Sidenote>.
