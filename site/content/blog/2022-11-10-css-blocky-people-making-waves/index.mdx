...
image = "./blocky-people.png"
favorite = true

+++


<link rel="stylesheet" href="/css/posts/blocky-people.css" />

It all started with [the code challenge](/blog/weekly-code-challenge-spring-2021/) in our office. The weekly theme was **waves**, and I tried to think outside of the box. After dropping a few ideas, I remembered <Sidenote note={`According to [Wikipedia](https://en.wikipedia.org/wiki/Wave_(audience)) these are known as Mexican or stadium waves`}>the waves people do on stadiums</Sidenote>.

So I made waves using CSS only (code is available on [CodePen](https://codepen.io/stanko/pen/JjZKaWX)):

<div className="people-wrapper is-in-viewport">
  <div className="row">
...
<Spoiler hide={"Hide HTML"} show={"Show HTML"}>
...
<div className="boxes-wrapper is-in-viewport">
  <css-box className="box no-transform"></css-box>
  <css-box className="box no-rotation"></css-box>
  <css-box className="box"></css-box>
</div>
...
<Spoiler hide={"Hide css-person web component"} show={"Show css-person web component"}>
...
<div className="people-wrapper people-wrapper-single">
  <css-person className="no-animation no-colors"></css-person>
</div>
<div className="rotation">
  <label htmlFor="r1">Rotation:</label>
  <input id="r1" defaultValue="60" min="0" max="360" type="range" className="rotation-input" />
</div>
...
<Spoiler hide={"Hide SCSS"} show={"Show SCSS"}>
...
<div className="people-wrapper people-wrapper-single">
  <css-person className="no-animation color-person person-1"></css-person>
</div>
<div className="rotation">
  <label htmlFor="r2">Rotation:</label>
  <input id="r2" defaultValue="60" min="0" max="360" type="range" className="rotation-input" />
</div>

<button className="btn btn--sm btn--empty next-color">Next color combination</button>
...
<div className="people-wrapper people-wrapper-single is-in-viewport">
  <css-person></css-person>
</div>
<div className="rotation">
  <label htmlFor="r3">Rotation:</label>
  <input id="r3" defaultValue="60" min="0" max="360" type="range" className="rotation-input" />
</div>
...
<div className="rotation">
  <label htmlFor="r4">Rotation:</label>
  <input id="r4" defaultValue="60" min="0" max="360" type="range" className="rotation-input" />
</div>
...
<div className="people-wrapper is-in-viewport">
  <div className="row">
    <css-person className="fan serbia"></css-person>
    <css-person className="fan serbia"></css-person>
    <css-person className="fan serbia"></css-person>
    <css-person className="fan serbia"></css-person>
    <css-person className="fan serbia"></css-person>
...
<div className="country-select">
  ...
  <label>
    <input type="radio" name="country" value="serbia" defaultChecked /> Serbia
  </label>
  <label>
