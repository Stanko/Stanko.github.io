...
tags = ["npm"," js"," git"]
comments = [
  "comments/add-git-version-tag-after-publishing-to-npm/1537341991448.json",
  "comments/add-git-version-tag-after-publishing-to-npm/1537347128892.json"
]
...
![Git tags are used as releases on GitHub](./tags-on-github.png)
...
<Sidenote note={`e.g. \`1.0.0\` or \`0.1.15\``}>version</Sidenote>
from `package.json`.
...
<Sidenote note={`Again, I don't like blindly pasting code snippets I find on the internet. You should be careful with that.`}>some research</Sidenote>
