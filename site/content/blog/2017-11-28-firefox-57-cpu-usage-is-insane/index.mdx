...
comments = [
  "comments/firefox-57-cpu-usage-is-insane/1512098412353.json",
  "comments/firefox-57-cpu-usage-is-insane/1512120916285.json",
  "comments/firefox-57-cpu-usage-is-insane/1531977954970.json"
]
...
<Sidenote note={`Although I use Chrome for development.`}>Chrome</Sidenote>
But few days ago I switched to Opera, because new Firefox's (aka Quantum)
CPU usage is insane.

<Image src='./ff.jpg' alt="Firefox CPU usage" />
