...
image = "/img/dual-range-input/thumbnail.png"
+++

<link rel="stylesheet" href="/posts/dual-range-input.css" />
...
![Screenshot showing that the range input's track is shorter than its total width](/img/dual-range-input/thumb-width.png)
...
![Screenshot showing padding on the wrapper to accommodate extra width](/img/dual-range-input/padding.png)
