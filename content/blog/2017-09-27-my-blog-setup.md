...
I wrote a couple of posts about using Jekyll already, and you can find them under [Jekyll category](/archive/#jekyll).

### Live reload

First thing I did was to add live reload for posts, Javascript and SCSS files.
You can read about it in [this post](/blog/jekyll-gulp-workflow/) but I plan to rewrite it as I feel it could be done better.
...
Again there is a [blog post](/blog/travis-jekyll-and-github-pages/) about that as well.
