...
<video poster="/img/axidraw/poster.jpg" class="video" controls="true" muted="true" playsinline="true" alt-text="White pen drawing stars on the black paper, the first video I recorded using the mount" src="/img/axidraw/stars.mp4#t=0.001"></video>
