...
I've seen this challenge on [Herman's blog](https://herman.bearblog.dev/bear-blog-question-challenge/). I liked it, so I decided to do my own version, even though I'm not using the bear blog. For the same reason, I slightly adapted [the original questions](https://blog.avas.space/bear-blog-challenge/).
...
It is probably [Draw SVG rope using JavaScript](/blog/draw-svg-rope-using-javascript/). It went through many drafts, and it took me a while to finish it. By the time I published it, I already had a love-hate relationship with the post. I was really excited about it, but I wasn't sure if it was any good. Luckily, it got recognized and exploded on Hacker News.
